...
#SBATCH --mem=32GB
#SBATCH --output=logs/eval_esm2_650m_f1-%j.out
#SBATCH --error=logs/eval_esm2_650m_f1-%j.err
#SBATCH --requeue

# Step 7: Calculate F1 for ESM2-650M
# Run after eval_esm2_650m_compare.sh array completes.
...
RESULTS_DIR="$INTERPLM_DIR/results/esm2_650m_layer_24"

echo "=== ESM2-650M F1 Calculation ==="
